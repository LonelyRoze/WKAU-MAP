...
mapImage = mapM.new("maps/agro/1fl.png", 2250, 500, -25, 200, sceneGroup)
...
local back = widget.newButton{
    ...
    onPress = function (event)
        ...
        composer.removeScene( "agroBuild1" )
    end
    }
